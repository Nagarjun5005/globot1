...
const vacancies = [
  { id: "Technical Project Manager (IRC258189)", Band : "Band 2 " , title: "Avenger", location: "Newyork, California", reward: "25000 INR" },
  { id: "TPM (IRC251984)", title: "Fantastic 4", Band : "Band 1 " , location: "India, Noida", reward: "25000 INR" },
  { id: "Technical Support Engineer (IRC251983)", Band : "Band 2 " , title: "Guardians Of Galaxy", location: "India, Noida", reward: "25000 INR" }
];
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-5xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <span className="font-bold text-orange-500"> IRP </span> <span> Job Portal</span>
        </h1>
        ...
        <div className="w-1/4 font-bold text-lg">Title</div>
        <div className="w-1/4 font-bold text-lg">Band</div>
        <div className="w-1/4 font-bold text-lg">Desgnation</div>
      </div>  
  {vacancies.map((vacancy) => (
    <div key={vacancy.id} className="flex justify-between items-center bg-gray-50 p-4 rounded-lg shadow-sm mb-4">
      
      {/* Left Section - Vacancy Details */}
      <div className="flex w-full gap-10 px-4">
        <div className="w-1/4">{vacancy.id}</div>
        <div className="w-1/4">{vacancy.Band}</div>
        <div className="w-1/4">{vacancy.location}</div>
      </div>

      {/* Right Section - Apply Button */}
      <div className="text-right">
        <button className="bg-orange-500 text-white px-3 py-1 mt-2 rounded">Apply</button>
      </div>
    </div>
  ))}
</div>
